/**
 * @param {keyof typeof import("discord.js").UserFlags} flag
 */
export function formatUserFlag(flag) {
	switch (flag) {
...
/**
 * @param {keyof typeof import("discord.js").ApplicationFlags} flag
 */
export function formatApplicationFlag(flag) {
	switch (flag) {
